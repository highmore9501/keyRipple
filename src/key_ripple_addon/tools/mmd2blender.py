...
def move_objs_to_bones(armature):
    ...
    for suffix in ["L", "R"]:
        ...
        if suffix == "L":
            move_obj_to_bone_position(
                armature, "親指２."+suffix, "4_"+suffix)
            move_obj_to_bone_position(
                armature, "人指３."+suffix, "3_"+suffix)
            move_obj_to_bone_position(
                armature, "中指３."+suffix, "2_"+suffix)
            move_obj_to_bone_position(
                armature, "薬指３."+suffix, "1_"+suffix)
            move_obj_to_bone_position(
                armature, "小指３."+suffix, "0_"+suffix)
        else:
            move_obj_to_bone_position(
                armature, "親指２."+suffix, "5_"+suffix)
            move_obj_to_bone_position(
                armature, "人指３."+suffix, "6_"+suffix)
            move_obj_to_bone_position(
                armature, "中指３."+suffix, "7_"+suffix)
            move_obj_to_bone_position(
                armature, "薬指３."+suffix, "8_"+suffix)
            move_obj_to_bone_position(
                armature, "小指３."+suffix, "9_"+suffix)
